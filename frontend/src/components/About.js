...
function About() {
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-6">About Arthaveil Pro</h2>
      <p className="mb-4">
      Arthaveil is dedicated to improving financial literacy and empowering individuals to make informed investment decisions. Our platform provides educational resources, tools, and real-time market information to help you navigate the complex world of finance.
      </p>
      ...
      <p>
      Arthaveil is backed by a team of financial experts, educators, and technology professionals committed to making finance accessible and understandable for everyone.
      </p>
    </motion.div>
  );
}
